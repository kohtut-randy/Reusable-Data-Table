...
const GYMS = [
  { id: 'bristol', label: 'CRUX Bristol', zones: 'Six zones' },
  { id: 'leeds', label: 'CRUX Leeds', zones: 'Four zones' },
]
    ...
    <div className='flex h-full flex-col gap-6 py-5'>
      <div className='flex items-center gap-2.5 px-6'>
        <span aria-hidden='true' className='grid size-8 shrink-0 place-items-center rounded-lg bg-surface-inverse'>
          <span className='font-display text-sm font-extrabold text-ink-inverse'>C</span>
        </span>
        <span className='font-display text-lg font-extrabold tracking-[-0.03em] text-ink'>CRUX</span>
          ...
          renderTrigger={props => (
            ...
            >
              <span className='flex min-w-0 flex-col'>
                <span className='truncate font-medium'>CRUX Bristol</span>
